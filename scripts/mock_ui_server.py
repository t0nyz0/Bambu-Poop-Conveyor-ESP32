...
RELEASES = {
    "stable": {"version": "1.5.1", "label": "v1.5.1", "bin": "https://t0nyz.com/flasher/Bambu-Poop-Conveyor-v1.5.1-ota.bin", "githubBin": "https://raw.githubusercontent.com/t0nyz0/Bambu-Poop-Conveyor-ESP32/Bambu-Conveyor-ESP32/firmware/releases/v1.5.1/Bambu-Poop-Conveyor-v1.5.1-ota.bin"},
